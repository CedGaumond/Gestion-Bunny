...
public class ApplicationDbContext : DbContext
{
  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder)
  {
    ...
    modelBuilder.Entity<ItemCategory>(entity =>
       {
         entity.ToTable("item_category", "public"); // Table name
         ...
         entity.HasMany(ic => ic.Items)
            .WithOne(i => i.ItemCategory) // Each Item has one ItemCategory
            .HasForeignKey(i => i.ItemCategoryId) // Foreign Key is ItemCategoryId in Item
            .OnDelete(DeleteBehavior.Restrict); // You can adjust the delete behavior as needed
       });

    modelBuilder.Entity<Item>(entity =>
{
  entity.ToTable("items", "public"); // Table name for Items
  ...
  entity.Property(i => i.ItemCategoryId).HasColumnName("item_category_id");
